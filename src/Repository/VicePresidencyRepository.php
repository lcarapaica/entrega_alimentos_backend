...
class VicePresidencyRepository extends ServiceEntityRepository
{
    ...
    public function add(VicePresidency $entity, bool $flush = false): void
    {
    ...
    public function remove(VicePresidency $entity, bool $flush = false): void
    {
...
//    /**
//     * @return VicePresidency[] Returns an array of VicePresidency objects
//     */
...
//    public function findOneBySomeField($value): ?VicePresidency
//    {
//        return $this->createQueryBuilder('v')
//            ->andWhere('v.exampleField = :val')
//            ->setParameter('val', $value)
